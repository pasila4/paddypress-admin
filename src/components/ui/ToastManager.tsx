...
export function ToastManager() {
  ...
  const variantStyles = {
    success:
      'border-green-200 bg-green-200 text-green-900 dark:bg-green-950/20 dark:border-green-500/20 dark:text-green-400',
    error:
      'border-red-200 bg-red-50 text-red-900 dark:bg-red-950/20 dark:border-red-500/20 dark:text-red-400',
    warning:
      'border-amber-200 bg-amber-50 text-amber-900 dark:bg-amber-950/20 dark:border-amber-500/20 dark:text-amber-400',
