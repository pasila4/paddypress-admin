...
export const AdminStatesListResponseSchema =
  PagedAdminResponseSchema(AdminStateSchema);
export type AdminStatesListResponse = z.infer<
  typeof AdminStatesListResponseSchema
>;

export const AdminDistrictsListResponseSchema =
  PagedAdminResponseSchema(AdminDistrictSchema);
export type AdminDistrictsListResponse = z.infer<
  typeof AdminDistrictsListResponseSchema
>;

export const AdminMandalsListResponseSchema =
  PagedAdminResponseSchema(AdminMandalSchema);
export type AdminMandalsListResponse = z.infer<
  typeof AdminMandalsListResponseSchema
>;

export const AdminVillagesListResponseSchema =
  PagedAdminResponseSchema(AdminVillageSchema);
export type AdminVillagesListResponse = z.infer<
  typeof AdminVillagesListResponseSchema
>;
...
export type CreateAdminStateRequest = z.infer<
  typeof CreateAdminStateRequestSchema
>;

export const UpdateAdminStateRequestSchema =
  CreateAdminStateRequestSchema.partial();
export type UpdateAdminStateRequest = z.infer<
  typeof UpdateAdminStateRequestSchema
>;
...
export type CreateAdminDistrictRequest = z.infer<
  typeof CreateAdminDistrictRequestSchema
>;
...
export type UpdateAdminDistrictRequest = z.infer<
  typeof UpdateAdminDistrictRequestSchema
>;
...
export type CreateAdminMandalRequest = z.infer<
  typeof CreateAdminMandalRequestSchema
>;
...
export type UpdateAdminMandalRequest = z.infer<
  typeof UpdateAdminMandalRequestSchema
>;
...
export type CreateAdminVillageRequest = z.infer<
  typeof CreateAdminVillageRequestSchema
>;
...
export type UpdateAdminVillageRequest = z.infer<
  typeof UpdateAdminVillageRequestSchema
>;
