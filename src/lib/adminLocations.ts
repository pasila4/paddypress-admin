...
export async function listAdminStates(
  ...
  const res = await apiFetch(
    `/admin/locations/states${qs.toString() ? `?${qs}` : ''}`,
  );
...
export async function updateAdminState(
  id: string,
  payload: UpdateAdminStateRequest,
) {
  ...
  const res = await apiFetch(
    `/admin/locations/states/${encodeURIComponent(id)}`,
    {
      method: 'PATCH',
      body: JSON.stringify(validated.data),
    },
...
export async function deleteAdminStatePermanently(id: string) {
  const res = await apiFetch(
    `/admin/locations/states/${encodeURIComponent(id)}/permanent`,
    {
      method: 'DELETE',
    },
  );
...
export async function listAdminDistricts(
  ...
  const res = await apiFetch(
    `/admin/locations/districts${qs.toString() ? `?${qs}` : ''}`,
  );
...
export async function updateAdminDistrict(
  id: string,
  payload: UpdateAdminDistrictRequest,
) {
  ...
  const res = await apiFetch(
    `/admin/locations/districts/${encodeURIComponent(id)}`,
    {
      method: 'PATCH',
      body: JSON.stringify(validated.data),
    },
...
export async function deleteAdminDistrictPermanently(id: string) {
  const res = await apiFetch(
    `/admin/locations/districts/${encodeURIComponent(id)}/permanent`,
    {
      method: 'DELETE',
    },
  );
...
export async function listAdminMandals(
  ...
  const res = await apiFetch(
    `/admin/locations/mandals${qs.toString() ? `?${qs}` : ''}`,
  );
...
export async function updateAdminMandal(
  id: string,
  payload: UpdateAdminMandalRequest,
) {
  ...
  const res = await apiFetch(
    `/admin/locations/mandals/${encodeURIComponent(id)}`,
    {
      method: 'PATCH',
      body: JSON.stringify(validated.data),
    },
...
export async function deleteAdminMandalPermanently(id: string) {
  const res = await apiFetch(
    `/admin/locations/mandals/${encodeURIComponent(id)}/permanent`,
    {
      method: 'DELETE',
    },
  );
...
export async function listAdminVillages(
  params: {
    page?: number;
    limit?: number;
    search?: string;
  ...
  const res = await apiFetch(
    `/admin/locations/villages${qs.toString() ? `?${qs}` : ''}`,
  );
...
export async function updateAdminVillage(
  id: string,
  payload: UpdateAdminVillageRequest,
) {
  ...
  const res = await apiFetch(
    `/admin/locations/villages/${encodeURIComponent(id)}`,
    {
      method: 'PATCH',
      body: JSON.stringify(validated.data),
    },
...
export async function deleteAdminVillagePermanently(id: string) {
  const res = await apiFetch(
    `/admin/locations/villages/${encodeURIComponent(id)}/permanent`,
    {
      method: 'DELETE',
    },
  );
